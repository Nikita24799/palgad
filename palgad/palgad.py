...
def delete(palk, inimesed): # удаляет человека и его зп
    ...
    return palk, inimesed       # удаляет человека и его зп

def kustutamine(): # Находит тех, кто получает зарплату ниже средней и удалить их из списков.
...
def sorteerimine(palk,inimesed): # сортирует 
    abi_p=0
    abi_i=""
    n=len(inimesed)
